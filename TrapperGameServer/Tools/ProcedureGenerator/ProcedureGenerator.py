...
def main():
    ...
    arg_parser.add_argument('--path', type=str, default='C:/Users/user/Documents/GitHub/TrapperGameServer/TrapperGameServer/TrapperGameServer/GameDB.xml', help='Xml Path')
